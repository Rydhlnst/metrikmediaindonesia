...
export function FooterServer() {
  return (
    <footer className="w-full mt-16 bg-white border-t border-black/10 text-foreground">
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 py-10 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              <a
                ...
                rel="noreferrer"
                aria-label="Twitter"
                className="p-2 bg-surface-container hover:bg-black hover:text-white transition-colors"
              >
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="text-xs font-bold uppercase tracking-widest text-foreground border-b-2 border-primary pb-1.5 inline-block">
                Kanal Berita
              </h4>
            ...
            {/* Column: Portal & Media */}
            <div className="flex flex-col gap-3">
              <h4 className="text-xs font-bold uppercase tracking-widest text-foreground border-b-2 border-gold pb-1.5 inline-block">
                Portal Media
              </h4>
              <ul className="space-y-2 text-xs font-medium">
        ...
        <div className="mt-10 pt-6 border-t border-black/10 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-muted-foreground">
          <div className="flex items-start gap-2.5">
            <MapPin className="size-4 shrink-0 text-gold-deep mt-0.5" />
            <span>Gedung Press Center Jakarta, Jl. Jend. Sudirman No. 45, Jakarta Pusat</span>
          </div>
          <div className="flex items-start gap-2.5">
            <EnvelopeSimple className="size-4 shrink-0 text-gold-deep mt-0.5" />
      ...
      <div className="bg-surface-container-low border-t border-black/10 pt-4 pb-20 md:pb-4">
        <div className="max-w-[1280px] mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-3 text-center md:text-left text-[11px] text-muted-foreground">
          <div>
          ...
          <div className="flex items-center gap-3 uppercase font-bold tracking-wider text-[10px] flex-wrap justify-center">
            <Link href="/tentang-kami" className="hover:text-gold-deep transition-colors">
              Pedoman Siber
            </Link>
            <span>•</span>
            <Link href="/tentang-kami" className="hover:text-gold-deep transition-colors">
            ...
            <span>•</span>
            <Link href="/hubungi-kami" className="hover:text-gold-deep transition-colors">
              Kontak Redaksi
            </Link>
          </div>
        </div>
