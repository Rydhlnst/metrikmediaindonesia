  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 pt-4">
        ...
        <h1 className="text-xl font-semibold leading-tight line-clamp-2 sm:text-2xl">
          {article.title}
        </h1>
        <p className="text-sm leading-relaxed text-muted-foreground line-clamp-3">
          {article.excerpt}
        </p>
        <span className="mt-1 text-xs font-semibold uppercase underline underline-offset-4">
          read more
        </span>
      </div>
    </Link>
